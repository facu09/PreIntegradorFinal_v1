                ...
                <form >
                    <div className="Rgst_FormCuenta" action="">
                        ...
                        <div className="Rgst_container-input">
                            ...
                            <input id= "name" className="Rgst_CamposEntrada" type="text" onChange={handleNombreChange} name="name" placeholder="Ingrese su nombre"/>
                        </div>
                        <div className="Rgst_container-input">
                            <label for="lastName">Apellido:</label>
                            <input id= "lastName" className="Rgst_CamposEntrada" type="text" onChange={handleApellidoChange} name="lastName" placeholder="Ingrese su apellido" />
                        </div>
                        <div className="Rgst_container-input">
                            <label for="nombre">Edad:</label>
                            <input id= "age" className="Rgst_CamposEntrada" type="text" onChange={handleEdadChange} name="age" placeholder="Ingrese su edad"/>
                        </div>
                        <div className="Rgst_container-input">
